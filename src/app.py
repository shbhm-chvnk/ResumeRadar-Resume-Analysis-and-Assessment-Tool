...
st.set_page_config(
    page_title="ResumeRadar - Resume Analysis and Assessment Tool",
)


def run():
    st.markdown("<h1 style='font-size:40.5px;'>Improve Your Resume<br>with Instant Analysis</h1>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: justify; font-size:18px;'>Our efficient Resume Analysis and Assessment Tool provides detailed evaluation and personalized recommendations based on key criteria valued by recruiters and hiring managers. Get actionable tips to enhance your resume's impact and increase your chances of landing interviews. Transform your resume with our straightforward, user-friendly tool designed to help you stand out in the job market. Start optimizing your resume now!</p>", unsafe_allow_html=True)
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'teamRR' and ad_password == 'Pass@123':
                st.success("Welcome, Team ResumeRadar!")
                # Display Data
